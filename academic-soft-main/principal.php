    ...
    <nav class="as-main-nav">
        <ul class="as-menu" id="as-menu">
            <li class="menu__item as-dropdown-submenu">
                ...
                <ul class="as-submenu">
                    <li class="menu__item">
                        <a href="principal.php?CONTENIDO=layout/inicio.php" class="as-menu__link as-submenu-color">Institución</a>
                    </li>
                    <li class="menu__item">
            ...
            <li class="menu__item as-dropdown-submenu">
                ...
                <ul class="as-submenu">
                    <li class="menu__item">
                        <a href="#" class="as-menu__link as-submenu-color">Digitar notas</a>
                    </li>
                    <li class="menu__item">
