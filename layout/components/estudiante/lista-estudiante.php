...
foreach ($listaUsuarios as $item) {
    ...
    $lista .= "<a class='as-add' href='principal.php?CONTENIDO=layout/components/notas/form-notas-create.php&accion=crear&id={$item->getId()}'>" . Generalidades::getTooltip(4, 'Agregar Calificación') . "</a>";
    $lista .= "</td>";
    $lista .= "</tr>";
    $count++;
}
